        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountSerial = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ReceiverMobileNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Currencies",
                columns: new[] { "Id", "Code", "Flag", "IsActive", "Name", "Symbol" },
                values: new object[,]
                {
                    { 1, "USD", "🇺🇸", true, "US Dollar", "$" },
                    { 2, "EUR", "🇪🇺", true, "Euro", "€" },
                    { 3, "GBP", "🇬🇧", true, "British Pound", "£" },
                    { 4, "LBP", "🇱🇧", true, "Lebanese Pound", "LL" },
                    { 5, "AED", "🇦🇪", true, "UAE Dirham", "د.إ" },
                    { 6, "SAR", "🇸🇦", true, "Saudi Riyal", "﷼" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommissionRates_FromCurrency_ToCurrency",
                table: "CommissionRates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_SerialNumber",
                table: "Transactions",
                column: "SerialNumber",
                unique: true);
        }
